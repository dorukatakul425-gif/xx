...
function VelvetApp() {
  ...
  if (screen === "profile") return <><style>{GLOBAL_CSS}</style><ProfileScreen name={displayName} onBack={() => setScreen("home")} onEnterRoom={enterRoom} onVip={() => setScreen("vip")} /></>;
  if (screen === "vip") return <><style>{GLOBAL_CSS}</style><VipScreen onBack={() => setScreen("profile")} /></>;
  return (
    <>
  ...
  return (
    <main style={{ background:"#07000f", minHeight:"100dvh", fontFamily:"'Helvetica Neue',Arial,sans-serif", position:"relative" }}>
      ...
      <div className="p-scroll">
        ...
        {/* VIP ROZET */}
        <div className="vip-rozet" style={{ position:"relative", overflow:"hidden" }}>
          <img src="/images/images/vip.png" style={{ position:"absolute", inset:0, width:"100%", height:"100%", objectFit:"cover", borderRadius:12, opacity:.9 }} alt="vip bg"/>
          <svg width="148" height="44" viewBox="0 0 148 44" style={{ position:"relative", zIndex:1 }}>
            <defs>
...
function VipScreen({ onBack }: { onBack: () => void }) {
  const CSS = `
    ...
    .vs-card-bg{position:absolute;inset:0;background:linear-gradient(150deg,#1c1c26,#13131a 40%,#1a1a24 75%,#0c0c14)}
    ...
    <main style={{ background:"#07000f", minHeight:"100dvh", fontFamily:"'Helvetica Neue',Arial,sans-serif" }}>
      ...
      <div className="vs-scroll">
        ...
        <div className="vs-card">
          <img src="/images/images/vip.png" style={{ position:"absolute", inset:0, width:"100%", height:"100%", objectFit:"cover", borderRadius:24, opacity:.55, zIndex:0 }} alt=""/>
          <div className="vs-card-bg" style={{ opacity:.5 }}/>
