                  ...
                  ref={el => {
                    if (el) {
                      try {
                        ...
                        if (av) el.innerHTML = `<img src="${av}" style="width:100%;height:100%;object-fit:cover;border-radius:50%"/>`;
                        else el.textContent = (profileData.username[0] || "D").toUpperCase();
                      } catch {}
                    }
                  }}>
                  {profileData.username[0]?.toUpperCase() || "D"}
                </div>
              </div>
