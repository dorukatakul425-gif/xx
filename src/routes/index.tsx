  ...
  return (
    <main style={{ background:"#07000f", minHeight:"100dvh", fontFamily:"'Helvetica Neue',Arial,sans-serif", position:"relative" }}>
      ...
      <div className="p-scroll">
        <div className="p-hero">
          ...
          <div className="p-body">
            <div style={{ position:"relative", flexShrink:0 }}>
              {/* Avatar — tıklandıqda tam ekranda açılır */}
        ...
        {/* VIP ROZET */}
        <div style={{ position:"relative", width:180, height:60, overflow:"hidden", borderRadius:12, margin:"14px 18px 0" }}>
          <img src="/images/images/viparxaplan.PNG" style={{ position:"absolute", inset:0, width:"115%", height:"100%", objectFit:"cover", objectPosition:"left center" }} alt=""/>
