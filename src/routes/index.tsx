    ...
    <main style={{ background:"#07000f", minHeight:"100dvh", fontFamily:"'Helvetica Neue',Arial,sans-serif", position:"relative" }}>
      ...
      <div className="p-scroll">
        ...
        <div style={{ margin:"12px 18px 0", display:"flex", alignItems:"center", gap:10 }}>
          ...
          {/* ID kartı — animasyonlu, rəngli */}
          <div style={{
            flex:1, height:54, borderRadius:12, position:"relative", overflow:"hidden",
            background:"linear-gradient(135deg,#0e0025,#1a003a)",
            border:"1px solid rgba(192,132,252,.25)",
            animation:"vipBadgePop 4s ease-in-out infinite"
          }}>
            <div style={{ position:"absolute", inset:0, background:"linear-gradient(90deg,transparent,rgba(192,132,252,.06),transparent)", backgroundSize:"200% 100%", animation:"vipShimmer 3s linear infinite" }}/>
            <div style={{ position:"relative", zIndex:2, height:"100%", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:2 }}>
              <span style={{ fontSize:9, letterSpacing:3, color:"rgba(192,132,252,.5)", textTransform:"uppercase" }}>İstifadəçi ID</span>
              <div style={{ display:"flex", alignItems:"center", gap:6 }}>
                <span style={{
                  fontSize:16, fontWeight:800, letterSpacing:1,
                  background:"linear-gradient(135deg,#c084fc,#ff3ea5,#c084fc)",
                  backgroundSize:"200% 100%",
                ...
                <button onClick={() => { navigator.clipboard?.writeText(userId).then(() => { setCopyDone(true); setTimeout(() => setCopyDone(false), 1500); }); }}
                  ...
                  {copyDone
                    ? <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#50c050" strokeWidth="2.5" strokeLinecap="round"><polyline points="20 6 9 17 4 12"/></svg>
                    : <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="rgba(192,132,252,.5)" strokeWidth="2" strokeLinecap="round"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1"/></svg>
                  }
                </button>
              </div>
            </div>
