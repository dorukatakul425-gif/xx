    ...
    <main style={{ background:"#07000f", minHeight:"100dvh", fontFamily:"'Helvetica Neue',Arial,sans-serif", position:"relative" }}>
      ...
      <div className="p-scroll">
        ...
        {(() => {
          ...
          const clampedVip = Math.min(userVip, 15); // max 15
          return (
            <div style={{
              ...
              />
              {/* Overlay qaraldıcı */}
              <div style={{ position:"absolute", inset:0, background:"rgba(0,0,0,.35)", borderRadius:10 }}/>
              {/* Sol VIP logo */}
              <img
                src={`/images/images/VIP${clampedVip}.png`}
